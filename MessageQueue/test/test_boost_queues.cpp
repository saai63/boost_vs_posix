...
TEST(boostMessageQueueTest, Test_MsgQ_init)
{
    MessageQueueIF *pMsg = new boost_queues("/TestMsgQueue", pLogger);
    EXPECT_TRUE(pMsg != NULL);
    delete pMsg;
}

TEST(boostMessageQueueTest, Test_MsgQ_create_ok)
{
    MessageQueueIF *pMsg = new boost_queues("/TestMsgQueue1", pLogger);
    EXPECT_TRUE(pMsg != NULL);
...
TEST(boostMessageQueueTest, Test_MsgQ_open_ng)
{
    MessageQueueIF *pMsg = new boost_queues("/TestMsgQueue1", pLogger);
    EXPECT_TRUE(pMsg != NULL);
...
TEST(boostMessageQueueTest, Test_MsgQ_open_ok)
{
    MessageQueueIF *pMsg = new boost_queues("/TestMsgQueue1", pLogger);
    EXPECT_TRUE(pMsg != NULL);
    EXPECT_TRUE(pMsg->bOpenQueue(MQ_CREATE, true, 10, 10));
...
TEST(boostMessageQueueTest, Test_MsgQ_open_or_create_ok)
{
    MessageQueueIF *pMsg = new boost_queues("/TestMsgQueue1", pLogger);
    EXPECT_TRUE(pMsg != NULL);
...
TEST(boostMessageQueueTest, Test_MsgQ_send_ng)
{
    MessageQueueIF *pMsg = new boost_queues("/TestMsgQueue", pLogger);
    EXPECT_TRUE(pMsg != NULL);
...
TEST(boostMessageQueueTest, Test_MsgQ_send_rcv_ok)
{
    MessageQueueIF *pMsg = new boost_queues("/TestMsgQueue1", pLogger);
    EXPECT_TRUE(pMsg != NULL);
